"1---python_code.ino" is basic python code that holds data as long as program is running. Once program closed, data is lost. In other words, it cannot store data permanantly. This code is not able to build App.

"3---python_code_CSV-file.ino" stores data parmanantly in an Excel file but this code runs only on python so it cannot be able to build App.
